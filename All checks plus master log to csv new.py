...
# read in the data files - first line reads in all sheets and second line reads in the dataset series tab individually 
# as it required the first row to be skipped to ensure correct column titles in the data frame.
df = pd.read_excel('dummy1.xlsx', sheet_name=None)
dataset_series = pd.read_excel('dummy1.xlsx', sheet_name='Dataset Series', skiprows=1)
...
# Extract data creator information
...
print(f"GCP DATASET NAME: {gcp_dataset_name}")
# Extract data creator information
